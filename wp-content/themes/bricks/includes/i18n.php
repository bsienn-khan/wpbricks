...
class I18n {
	...
	public static function get_builder_i18n() {
		return [
			...
			'styleManagerFrameworkAddCustomCss'           => __( 'Add declarations as custom CSS', 'bricks' ),
			'styleManagerFrameworkAddCustomCssDesc'       => __( 'If enabled, the declaration of each class will be added as custom CSS to the class settings. If unchecked, only the class name will be created, and you have to load the CSS file yourself.', 'bricks' ),
