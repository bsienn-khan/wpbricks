...
// Get base breakpoint key
$breakpoints = \Bricks\Breakpoints::get_breakpoints() ?? [];
$base_breakpoint = array_filter($breakpoints, function($breakpoint) {
    return !empty($breakpoint['base']);
});
...
$page_custom_css = isset($page_settings_arr) && isset($page_settings_arr[$css_key]) ? stripslashes($page_settings_arr[$css_key]) : '';
$page_custom_sass = isset($page_settings_arr) && isset($page_settings_arr[$sass_key]) ? stripslashes($page_settings_arr[$sass_key]) : '';
